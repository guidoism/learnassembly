...
| *JMP*{:.smallcaps} | Jump. |
| *JE/JZ*{:.smallcaps} | Jump if equal/Jump if zero. |
| *JNE/JNZ*{:.smallcaps} | Jump if not equal/Jump if not zero. |
| *JA/JNBE*{:.smallcaps} | Jump if above/Jump if not below or equal. |
| *JAE/JNB*{:.smallcaps} | Jump if above or equal/Jump if not below. |
| *JB/JNAE*{:.smallcaps} | Jump if below/Jump if not above or equal. |
| *JBE/JNA*{:.smallcaps} | Jump if below or equal/Jump if not above. |
| *JG/JNLE*{:.smallcaps} | Jump if greater/Jump if not less or equal. |
| *JGE/JNL*{:.smallcaps} | Jump if greater or equal/Jump if not less. |
| *JL/JNGE*{:.smallcaps} | Jump if less/Jump if not greater or equal. |
| *JLE/JNG*{:.smallcaps} | Jump if less or equal/Jump if not greater. |
| *JC*{:.smallcaps} | Jump if carry. |
| *JNC*{:.smallcaps} | Jump if not carry. |
| *JO*{:.smallcaps} | Jump if overflow. |
| *JNO*{:.smallcaps} | Jump if not overflow. |
| *JS*{:.smallcaps} | Jump if sign (negative). |
| *JNS*{:.smallcaps} | Jump if not sign (non-negative). |
| *JPO/JNP*{:.smallcaps} | Jump if parity odd/Jump if not parity. |
| *JPE/JP*{:.smallcaps} | Jump if parity even/Jump if parity. |
| *JCXZ/JECXZ*{:.smallcaps} | Jump register CX zero/Jump register ECX zero. |
| *LOOP*{:.smallcaps} | Loop with ECX counter. |
| *LOOPZ/LOOPE*{:.smallcaps} | Loop with ECX and zero/Loop with ECX and equal. |
| *LOOPNZ/LOOPNE*{:.smallcaps} | Loop with ECX and not zero/Loop with ECX and not equal. |
| *CALL*{:.smallcaps} | Call procedure. |
| *RET*{:.smallcaps} | Return. |
| *IRET*{:.smallcaps} | Return from interrupt. |
| *INT*{:.smallcaps} | Software interrupt. |
| *INTO*{:.smallcaps} | Interrupt on overflow. |
| *BOUND*{:.smallcaps} | Detect value out of range. |
| *ENTER*{:.smallcaps} | High-level procedure entry. |
| *LEAVE*{:.smallcaps} | High-level procedure exit. |
